<template>
    ...
    <div class="flex items-center justify-center mb-4">
        <h5>Загрузите проротокол защиты ВКР</h5>
    </div>
    ...
    <div class="max-w-screen-xl flex flex-wrap items-baseline mx-auto p-4 mt-5">
        ...
        <div class="relative max-w-sm">
            <select id="score" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
